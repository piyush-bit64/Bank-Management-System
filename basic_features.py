...
# defining a function for depositing money in bank
...
# defining a function for withdrawing money from bank
...
# defining a function for checking the balance of bank account
...
# defining a function for transfering funds to one account to another
...
# defining a function for viewing transaction history of the user's bank account
...
# defining a function for checking the loan eligibility with some conditions
...
# defining a function so that if user has done a wrong transaction so that he /she can report
...
# defining a function so that user can update his/ her personal information
