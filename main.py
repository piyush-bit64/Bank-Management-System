...
''' defining a function where user is given a homepage where he can choose
what he want to do like checking balance, updating account details, etc. '''
def home(acc_no):
    print("\n" + "." * 50)
    print(":                  BANK SYSTEM                   :")
    print("." * 50)
...
'''defining a control menu where user is asked to go back or exit the system'''
...
''' deifining a function where user is given a start menu where he/she 
have to choose wheather he/she want to login or create new account'''
def start_menu():
    print("\n" + "." * 50)
    print(":                  BANK SYSTEM                   :")
    print("." * 50)
